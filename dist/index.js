...
const BISOCIATIVE_SYNTHESIS_TOOL = {
...
- Rhizome map visualizing the associative web`,
    inputSchema: {
        ...
        properties: {
            priorOutputs: {
                type: "array",
                description: "Array of previous MCP tool outputs to force into collision",
                items: {
                    type: "object",
                    properties: {
                        tool: {
                        ...
                        timestamp: {
                            type: "number",
                            description: "Optional timestamp of when this output was generated",
                        },
                    },
            ...
            chaosIntensity: {
                type: "number",
                description: "How wild to make the meta-leaps (0.0 to 1.0, higher = more chaotic)",
                minimum: 0,
                maximum: 1,
            },
            contextAnchor: {
...
const PROMPTS = [
    {
        ...
        description: "Break through creative blocks with a powerful 3-step sequence: drift → oblique → bisociate. Best for when you're completely stuck.",
        arguments: [
            {
                name: "problem",
    ...
    },
    {
        ...
        description: "Maximum chaos exploration: serendipity → meta → drift. High novelty, perfect for discovering unknown unknowns.",
        arguments: [
            {
                name: "domain",
    ...
    },
    {
        ...
        description: "Balanced innovation workflow: bisociate → drift → meta. Generates radical ideas while maintaining coherence.",
        arguments: [
            {
                name: "challenge",
    ...
    },
    {
        ...
        description: "Reframe problems from multiple angles: oblique → serendipity → bisociate. Transforms how you see the problem.",
        arguments: [
            {
                name: "problem",
    ...
    },
    {
        ...
        description: "The complete associative dreaming experience: all 5 tools in optimal sequence ending with meta-association chaos weaving.",
        arguments: [
            {
                name: "seed",
    ...
    switch (uri) {
        ...
        case "graph://stats": {
            ...
            const stats = {
                ...
                averageEdgesPerNode: nodes.length > 0 ? (edges.length / nodes.length).toFixed(2) : 0,
                edgeTypeDistribution: edges.reduce((acc, e) => {
...
Present 3 radically different ways to frame "${problem}" based on what emerged.`,
        ...
        case "full-dream-sequence": {
            ...
            const chaos = chaosValues[chaosLevel] || 0.6;
            return {
                messages: [
                    {
                        role: "user",
